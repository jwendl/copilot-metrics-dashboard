...
export default async function Home(props: IProps) {
  ...
  const validUserEmails: string[] = ["juswen@microsoft.com", "altsang@microsoft.com", "katerayner@microsoft.com", "philcousins@microsoft.com", "dermille@microsoft.com", "phlucas@microsoft.com", "relghazi@microsoft.com", "macook@microsoft.com"];
